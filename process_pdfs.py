...
Original file is located at
    https://colab.research.google.com/drive/140b0ySmnGxhqaSg9xhyIUfFC-LwL_n87
"""
...
class AdvancedPDFHeadingExtractor:
    ...
    def setup_models(self):
        ...
        try:
            ...
            self.layout.model = lp.models.detectron2.Detectron2LayoutModel(
    ...
    def calculate_heading_score(self, block: Dict, doc_stats: Dict, layout_info: Dict) -> float:
        ...
        if re.match(r'^[A-Z][A-Z\s]+$', text) and len(text) > 5:  # All caps
            score += 0.15
        if text.endswith(':') and word_count < 10:  # Ends with colon
            score += 0.15
    ...
    def assign_hierarchy_levels(self, candidates: List[HeadingCandidate]) -> List[HeadingCandidate]:
        ...
        for i, group in enumerate(font_groups[:3]):
            level = level_names[i]
